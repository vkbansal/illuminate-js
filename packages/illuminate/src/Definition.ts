...
type Tokens = RegExp | TokenObject | TokenObject[];
...
export default class Definition {
    private __def: Map<string, Tokens>;

    constructor(def: ([string, Tokens])[] | Map<string, Tokens>) {
...
export function isDefLike(val: Definition | Map<string, Tokens>) {
