...
var _loop = function _loop(_key15) {
  ...
  Object.defineProperty(exports, _key15, {
    enumerable: true,
    get: function get() {
      return _apacheconf[_key15];
    }
  });
};

for (var _key15 in _apacheconf) {
  var _ret = _loop(_key15);
...
var _loop2 = function _loop2(_key16) {
  if (_key16 === "default") return "continue";
  Object.defineProperty(exports, _key16, {
    enumerable: true,
    get: function get() {
      return _clike[_key16];
    }
  });
};

for (var _key16 in _clike) {
  var _ret2 = _loop2(_key16);
...
var _loop3 = function _loop3(_key17) {
...
for (var _key17 in _css) {
  var _ret3 = _loop3(_key17);
...
var _loop4 = function _loop4(_key18) {
...
for (var _key18 in _diff) {
  var _ret4 = _loop4(_key18);
...
var _loop5 = function _loop5(_key19) {
...
for (var _key19 in _http) {
  var _ret5 = _loop5(_key19);
...
var _loop6 = function _loop6(_key20) {
...
for (var _key20 in _ini) {
  var _ret6 = _loop6(_key20);
...
var _loop7 = function _loop7(_key21) {
  if (_key21 === "default") return "continue";
  Object.defineProperty(exports, _key21, {
    enumerable: true,
    get: function get() {
      return _javascript[_key21];
    }
  });
};

for (var _key21 in _javascript) {
  var _ret7 = _loop7(_key21);
...
var _loop8 = function _loop8(_key22) {
...
for (var _key22 in _jsx) {
  var _ret8 = _loop8(_key22);
...
for (var _key23 in _less) {
  var _ret9 = _loop9(_key23);
...
var _loop10 = function _loop10(_key24) {
  if (_key24 === "default") return "continue";
  Object.defineProperty(exports, _key24, {
    enumerable: true,
    get: function get() {
      return _markup[_key24];
    }
  });
};

for (var _key24 in _markup) {
  var _ret10 = _loop10(_key24);
...
var _loop11 = function _loop11(_key25) {
...
for (var _key25 in _php) {
  var _ret11 = _loop11(_key25);
...
var _loop12 = function _loop12(_key26) {
...
for (var _key26 in _sass) {
  var _ret12 = _loop12(_key26);
...
var _loop13 = function _loop13(_key27) {
...
for (var _key27 in _scss) {
  var _ret13 = _loop13(_key27);
...
var _loop14 = function _loop14(_key28) {
...
for (var _key28 in _yaml) {
  var _ret14 = _loop14(_key28);
